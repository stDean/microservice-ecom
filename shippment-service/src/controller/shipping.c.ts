...
export const ShippingCtrl = {
  getUserShippings: async (req: Request, res: Response) => {
  ...
  getShippingByOrderId: async (req: Request, res: Response) => {
  ...
  getShippingByTrackingNumber: async (req: Request, res: Response) => {
